...
class MongoClient {
  constructor() {
    this.host = config.get('db.host') ? config.get('db.host') : process.env.NODE_DB_HOST;
    this.port = config.get('db.port') ? config.get('db.port') : process.env.NODE_DB_PORT;
    this.database = config.get('db.name') ? config.get('db.name') : process.env.NODE_DB_NAME;
    this.user = config.get('db.user') ? config.get('db.user') : process.env.NODE_DB_USER;
    this.password = config.get('db.password') ? config.get('db.password') : process.env.NODE_DB_PASSWORD;
